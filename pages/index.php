...
<body>
    <div class="loading-container">
        <img src="../assets/images/Nav_LogoClosed.png" alt="CHO Koronadal Logo" class="logo" 
             onerror="this.src='https://ik.imagekit.io/wbhsmslogo/Nav_LogoClosed.png?updatedAt=1751197276128'">
