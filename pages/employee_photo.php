<?php
// pages/employee_photo.php - Compatibility controller for topbar paths
// This handles cases where topbar generates paths to /pages/employee_photo.php
...
try {
    ...
    error_log("Pages Employee Photo Controller Error: " . $e->getMessage());
    header('Location: ' . $default_image_url);
    exit;
}
?>