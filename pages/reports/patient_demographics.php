...
<body>
    ...
    <section class="homepage">
        <div class="content-wrapper">
            ...
            <div class="report-overview">
                ...
                <p>This report provides detailed insights into patient demographics including age distribution, sex breakdown, and barangay representation. Use this data to understand your patient population and make informed healthcare planning decisions.</p>
            </div>

            <!-- Demographics Content -->
            <div class="demographics-content">
                <div class="report-actions">
                    <button class="btn btn-primary" onclick="openFullReportPopup()">
                ...
                <?php if ($total_patients > 0): ?>
                    ...
                    <div class="charts-grid">
                        ...
                        <div class="chart-container">
                            <div class="chart-header">
                                <h4><i class="fas fa-venus-mars"></i> Sex Distribution</h4>
                    ...
                    <div class="print-summary avoid-break" style="display: none;">
                        ...
                        <p><strong>Generated By:</strong> <?= htmlspecialchars($_SESSION['employee_name'] ?? ($_SESSION['employee_first_name'] . ' ' . $_SESSION['employee_last_name']) ?? 'System User') ?> (<?= htmlspecialchars(ucfirst($_SESSION['role'])) ?>)</p>
    ...
    <!-- Sex Distribution Modal -->
    <div id="genderModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h3><i class="fas fa-venus-mars"></i> Sex Distribution - Detailed View</h3>
            ...
            <div class="modal-body">
                ...
                <div id="gender-overview" class="modal-tab-content active">
                    ...
                    <div class="modal-table-section">
                        <h4><i class="fas fa-table"></i> Detailed Sex Statistics</h4>
                        <div class="modal-table-wrapper">
                            <table class="modal-data-table">
                                <thead>
                                    <tr>
                ...
                <div id="gender-district" class="modal-tab-content">
                    <div class="modal-table-section">
                        <h4><i class="fas fa-map-marked-alt"></i> Sex Distribution by District</h4>
                ...
                <div id="gender-barangay" class="modal-tab-content">
                    <div class="modal-table-section">
                        <h4><i class="fas fa-map-marker-alt"></i> Sex Distribution by Barangay</h4>
    ...
    <script>
        ...
        function exportFullReportExcel() {
            ...
            csvContent += "Sex,Count,Percentage,Ratio\n";
            const genderTotal = genderData.reduce((sum, item) => sum + parseInt(item.count), 0);
        ...
        function openFullReportPopup() {
            // Open the full report page in a popup window optimized for printing
            const popupWindow = window.open(
                'patient_demographics_full_report.php',
                'fullReportPopup',
            ...
            if (popupWindow) {
                ...
                alert('Please allow popups for this site to open the full report in a new window.');
                // Open in new tab as fallback
                window.open('patient_demographics_full_report.php', '_blank');
            }
        }
                    ...
                    <div class="report-content">
                        ...
                        <div class="gender-section">
                            ...
                            <div class="definition-box">
                                ...
                                <p><strong>Metrics:</strong> Count, percentage, and sex ratio</p>
                            </div>
                            <table class="full-report-table">
                                <thead>
                                    <tr>
                        ...
                        <div class="gender-section">
                            <h2>Sex Distribution by District</h2>
                            <div class="definition-box">
                                <p><strong>Categories:</strong> Sex per district</p>
                                <p><strong>Metrics:</strong> Count and percentage per sex within each district</p>
                            </div>
                            ${generateGenderByDistrictTables()}
                        </div>
                        
                        <div class="gender-section">
                            <h2>Sex Distribution by Barangay</h2>
                            <div class="definition-box">
                                <p><strong>Categories:</strong> Sex per barangay</p>
                                <p><strong>Metrics:</strong> Count and percentage per sex within each barangay</p>
                            </div>
                ...
                html += `
                    <div class="breakdown-table">
                        ...
                        <table class="breakdown-data-table">
                            <thead>
                                <tr>
                                    <th>${groupField === 'age_group' ? 'Age Group' : groupField === 'gender' ? 'Sex' : 'PhilHealth Type'}</th>
                                    <th>Count</th>
                                    <th>% of ${location}</th>
                                    <th>% of Total</th>
                                </tr>
