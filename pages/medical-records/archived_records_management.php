...
// Check authentication and authorization - only admin and records_officer can access archived records
$authorized_roles = ['admin', 'records_officer'];
require_employee_auth($authorized_roles);

// Set active page for sidebar highlighting
$activePage = 'patient_records';

// Define role-based permissions - only admin can deactivate/reactivate patients
$employee_role = $_SESSION['role'];
$canEdit = in_array(strtolower($employee_role), ['admin']); // Only admin can reactivate patients
$canView = true; // Both admin and records_officer can view archived patients
...
<head>
    ...
    <title>Archived Patient Records - <?php echo ucfirst($_SESSION['role']); ?> | CHO Koronadal</title>
    <!-- CSS Files -->
...
<body>
    <!-- Include sidebar -->
    <?php
    // Include appropriate sidebar based on user role (admin or records_officer)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="action-buttons">
                                                    ...
                                                    <?php if ($canEdit): // Only admin can reactivate 
                                                    ?>
