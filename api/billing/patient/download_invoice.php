<?php
/**
 * Download Invoice API (Patient)
 * Generate downloadable invoice for patient access only
 */
...
try {
    ...
    // Get invoice data (same structure as view_invoice API)
    $invoice_sql = "
        SELECT 
            b.billing_id,
            b.total_amount,
    ...
    // Format invoice data (similar to view_invoice API but without sensitive staff info)
    $invoice_data = [
        'invoice' => [
    ...
    error_log("Patient download invoice API error: " . $e->getMessage());
